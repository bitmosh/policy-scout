...
the ADR is implemented. This index records the v0.3.9 code status independently.
...
| [005](ADR-005-registry-coverage-expansion.md) | Registry and eval coverage | **Planned/partial:** current registry remains 15 entries and eval remains 44 cases; proposed coverage command and ecosystem expansion are absent |
