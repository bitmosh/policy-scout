...
| Lattica integration | **Live (two paths)** | Track A: 4 Tauri commands in Lattica shell out to policy-scout CLI with --json; Track B: Fossic relay backfills and streams posture/decision events. Both paths live. |
